...
public final class ServeUtil {
    ...
    public static double angleDifference(double a, double b) {
        ...
        return Math.min(diff, MathConstants.kTau - diff);
    }
    ...
    public static double normalizeAngle(double angle) {
        return ((angle % MathConstants.kTau) + MathConstants.kTau) % MathConstants.kTau; // fix negative angles
    }
}
