...
public final class MotorConstants {
    public static final class Neo {
        ...
        public static final double kFreeSpeed =
                RotationsPerSecond.of(5676.0 / 60.0).in(RadiansPerSecond);
    ...
    public static final class NeoVortex {
        ...
        public static final double kFreeSpeed =
                RotationsPerSecond.of(6784.0 / 60.0).in(RadiansPerSecond);
    ...
    public static final class Neo550 {
        ...
        public static final double kFreeSpeed =
                RotationsPerSecond.of(11000.0 / 60.0).in(RadiansPerSecond);
